...
const EditStudent = () => {
    ...
    useEffect(()=>{
        axios
        .get(`https://mern10ambackend.onrender.com/student/${sno}`)
        .then((res)=>{
    ...
    const submitHandler=(e)=>{
        e.preventDefault();
        axios.put(`https://mern10ambackend.onrender.com/student/${sno}`,{name,email,phone,address})
        .then((res)=>{
            ...
            <div className='row'>
                <div className='col-md-12'>
                    ...
                    <ul className='d-flex justify-content-center breadcrumb'>
                        ...
                        <li className='breadcrumb-item'><NavLink to="/addstudent">EditStudent</NavLink></li>
                    </ul>
                </div>
            </div>
    </div>
